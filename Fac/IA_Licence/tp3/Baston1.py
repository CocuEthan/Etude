...
def jouerPartie(N, k):
    ...
    while True:
        ...
        while batonsRestants > 0:
            ...
            IA.MAJCompteurs(batonsRestants + mouvementIA, gagne=False) # Mettre à jour les compteurs après le mouvement de l'IA
            if batonsRestants <= 0:
                print("IA gagne!")
                break
            print("Bâtons restants:", batonsRestants)
            ...
            IA.MAJCompteurs(batonsRestants + mouvementHumain, gagne=True) # Mettre à jour les compteurs après le mouvement du joueur
            if batonsRestants <= 0:
                print("Vous gagnez!")
                break
